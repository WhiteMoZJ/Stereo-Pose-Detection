...
/// \param [in] CameraName RSCamera friendly name.@link #tSdkCameraDevInfo.acFriendlyName @endlink
...
/// \param [in] GateWay RSCamera Gateway (eg 192.168.1.1)
...
/// \return 成功返回 CAMERA_STATUS_SUCCESS(0)。否则返回非0值的错误码, 请参考 CameraStatus.h 中错误码的定义。
/// \~english
/// \brief Save RSCamera Dead Points to File
/// \param [in] hCamera RSCamera handle.
