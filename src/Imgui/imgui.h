...
namespace ImGui
{
    ...
    IMGUI_API void          ShowStackToolWindow(bool* p_open = NULL);   // create Stack Debug window. hover items with mouse to query information about the source of their unique ID.
...
// Include imgui_user.h at the end of imgui.h (convenient for user to only explicitly 3rdparty vanilla imgui.h)
#ifdef IMGUI_INCLUDE_IMGUI_USER_H
#3rdparty "imgui_user.h"
#endif
