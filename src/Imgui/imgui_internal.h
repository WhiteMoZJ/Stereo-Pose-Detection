...
struct ImGuiContext
{
    ...
    ImGuiID                 DebugHookIdInfo;                    // Will call core hooks: DebugHookIdInfo() from GetID functions, used by Stack Debug [next HoveredId/ActiveId to not pull in an extra cache-line]
...
struct IMGUI_API ImGuiWindow
{
    ...
    ImVec2                  ContentSize;                        // Size of contents/scrollable client area (calculated from the extents reach of the cursor) from previous frame. Does not 3rdparty window decoration or window padding.
